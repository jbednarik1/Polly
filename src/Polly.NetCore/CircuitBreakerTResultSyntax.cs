...
namespace Polly
{
    ...
    public static class CircuitBreakerTResultSyntax
    {
        ...
        ///     <para>
        ///         The circuit will break if <paramref name="handledEventsAllowedBeforeBreaking" />
        ...
        ///     The number of exceptions or handled results that are allowed before
        ///     opening the circuit.
        /// </param>
        ...
        ///     handledEventsAllowedBeforeBreaking;Value must be greater than
        ///     zero.
        /// </exception>
        /// <exception cref="ArgumentNullException">onBreak</exception>
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int handledEventsAllowedBeforeBreaking,
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int handledEventsAllowedBeforeBreaking,
                                                                            TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan> onBreak,
                                                                            Action onReset)
        {
            return policyBuilder.CircuitBreaker(
                                                handledEventsAllowedBeforeBreaking,
        ...
        /// <exception cref="ArgumentNullException">onReset</exception>
        public static CircuitBreakerPolicy<TResult> CircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, int handledEventsAllowedBeforeBreaking,
                                                                            TimeSpan durationOfBreak, Action<DelegateResult<TResult>, TimeSpan, Context> onBreak,
