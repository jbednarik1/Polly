...
namespace Polly
{
    public partial class PolicyBuilder
    {
        ...
        /// <remarks>
        ///     This policy filter matches the <paramref name="result" /> value returned using .Equals(), ideally suited for
        ///     value types such as int and enum.  To match characteristics of class return types, consider the overload taking a
        ///     result predicate.
        /// </remarks>
        /// <returns>The PolicyBuilder instance.</returns>
