...
namespace Polly
{
    ...
    {
        readonly Func<Func<CancellationToken, Task>, Context, CancellationToken, bool, Task> _asyncExceptionPolicy;
        ...
        ///     A cancellation token which can be used to cancel the action.  When a retry policy in
        ///     use, also cancels any further retries.
        /// </param>
        [DebuggerStepThrough]
        ...
        ///     Please use the asynchronous RetryAsync, RetryForeverAsync,
        ///     WaitAndRetryAsync or CircuitBreakerAsync methods when calling the asynchronous Execute method.
        /// </exception>
        [DebuggerStepThrough]
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task ExecuteAsync(Func<CancellationToken, Task> action, Context context, CancellationToken cancellationToken,
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task<PolicyResult> ExecuteAndCaptureAsync(Func<CancellationToken, Task> action, Context context, CancellationToken cancellationToken,
                                                                  bool continueOnCapturedContext)
        {
            if (_asyncExceptionPolicy == null)
                throw new InvalidOperationException
        ...
        /// <param name="action">The action to perform.</param>
        /// <param name="cancellationToken">
        ///     A cancellation token which can be used to cancel the action.  When a retry policy is in
        ///     use, also cancels any further retries.
        /// </param>
        /// <returns>The value returned by the action</returns>
        [DebuggerStepThrough]
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task<TResult> ExecuteAsync<TResult>(Func<CancellationToken, Task<TResult>> action, Context context, CancellationToken cancellationToken,
                                                            bool continueOnCapturedContext)
        {
            if (_asyncExceptionPolicy == null)
                throw new InvalidOperationException(
            ...
            await
                _asyncExceptionPolicy(async ct => { result = await action(ct).ConfigureAwait(continueOnCapturedContext); }, context, cancellationToken,
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task<PolicyResult<TResult>> ExecuteAndCaptureAsync<TResult>(Func<CancellationToken, Task<TResult>> action, Context context,
    ...
    {
        readonly Func<Func<CancellationToken, Task<TResult>>, Context, CancellationToken, bool, Task<TResult>> _asyncExecutionPolicy;
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task<TResult> ExecuteAsync(Func<CancellationToken, Task<TResult>> action, Context context, CancellationToken cancellationToken,
                                                   bool continueOnCapturedContext)
        {
            ...
            var result = await _asyncExecutionPolicy(
                                                     action,
                                                     context,
                                                     cancellationToken,
                                                     continueOnCapturedContext)
        ...
        /// </exception>
        [DebuggerStepThrough]
        protected async Task<PolicyResult<TResult>> ExecuteAndCaptureAsync(Func<CancellationToken, Task<TResult>> action, Context context,
                                                                           CancellationToken cancellationToken, bool continueOnCapturedContext)
        {
            if (_asyncExecutionPolicy == null)
                throw new InvalidOperationException(
