...
namespace Polly
{
    ...
    public static class AdvancedCircuitBreakerTResultSyntaxAsync
    {
        ...
        ///     <para>
        ///         The circuit will break if, within any timeslice of duration <paramref name="samplingDuration" />, the
        ///         proportion of actions resulting in a handled exception or result exceeds <paramref name="failureThreshold" />,
        ///         provided also that the number of actions through the circuit in the timeslice is at least
        ///         <paramref name="minimumThroughput" />.
        ///     </para>
        ///     <para>
        ///         The circuit will stay broken for the <paramref name="durationOfBreak" />. Any attempt to execute this policy
        ///         while the circuit is broken, will immediately throw a <see cref="BrokenCircuitException" /> containing the
        ///         exception or result
        ///         that broke the circuit.
        ///     </para>
        ///     <para>
        ///         If the first action after the break duration period results in a handled exception or result, the circuit will
        ///         break
        ///         again for another <paramref name="durationOfBreak" />; if no exception or handled result is encountered, the
        ///         circuit will reset.
        ///     </para>
        /// </summary>
        /// <param name="policyBuilder">The policy builder.</param>
        /// <param name="failureThreshold">
        ///     The failure threshold at which the circuit will break (a number between 0 and 1; eg 0.5
        ///     represents breaking if 50% or more of actions result in a handled failure.
        /// </param>
        ...
        ///     The minimum throughput: this many actions or more must pass through the circuit in the
        ///     timeslice, for statistics to be considered significant and the circuit-breaker to come into action.
        /// </param>
        ...
        ///     samplingDuration;Value must be equal to or greater than the minimum
        ///     resolution of the CircuitBreaker timer
        /// </exception>
        ...
        public static CircuitBreakerPolicy<TResult> AdvancedCircuitBreakerAsync<TResult>(this PolicyBuilder<TResult> policyBuilder, double failureThreshold,
                                                                                         TimeSpan samplingDuration, int minimumThroughput,
        ...
        ///     <para>
        ///         The circuit will break if, within any timeslice of duration <paramref name="samplingDuration" />, the
        ///         proportion of actions resulting in a handled exception exceeds <paramref name="failureThreshold" />, provided
        ///         also that the number of actions through the circuit in the timeslice is at least
        ///         <paramref name="minimumThroughput" />.
        ///     </para>
        ///     <para>
        ///         The circuit will stay broken for the <paramref name="durationOfBreak" />. Any attempt to execute this policy
        ...
        public static CircuitBreakerPolicy<TResult> AdvancedCircuitBreakerAsync<TResult>(this PolicyBuilder<TResult> policyBuilder, double failureThreshold,
                                                                                         TimeSpan samplingDuration, int minimumThroughput,
                                                                                         TimeSpan durationOfBreak,
                                                                                         Action<DelegateResult<TResult>, TimeSpan> onBreak, Action onReset)
        {
            return policyBuilder.AdvancedCircuitBreakerAsync(
                                                             failureThreshold, samplingDuration, minimumThroughput,
                                                             durationOfBreak,
        ...
        /// <param name="onBreak">The action to call when the circuit transitions to an <see cref="CircuitState.Open" /> state.</param>
        /// <param name="onReset">The action to call when the circuit resets to a <see cref="CircuitState.Closed" /> state.</param>
        /// <param name="onHalfOpen">
        ///     The action to call when the circuit transitions to <see cref="CircuitState.HalfOpen" /> state,
        ///     ready to try action executions again.
        /// </param>
        /// <returns>The policy instance.</returns>
        /// <remarks>(see "Release It!" by Michael T. Nygard fi)</remarks>
        /// <exception cref="ArgumentOutOfRangeException">failureThreshold;Value must be greater than zero</exception>
                                                                                         ...
                                                                                         Action<Context> onReset, Action onHalfOpen)
        {
            ...
            if (samplingDuration < resolutionOfCircuit)
                throw new ArgumentOutOfRangeException("samplingDuration",
                                                      string.Format(
                                                                    "Value must be equal to or greater than {0} milliseconds. This is the minimum resolution of the CircuitBreaker timer.",
                                                                    resolutionOfCircuit.TotalMilliseconds));
