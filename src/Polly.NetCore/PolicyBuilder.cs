...
namespace Polly
{
    ...
    public sealed partial class PolicyBuilder
    {
        ...
        internal IList<ExceptionPredicate> ExceptionPredicates { get; }
    ...
    public sealed partial class PolicyBuilder<TResult>
    {
        ...
        {
            ExceptionPredicates = new List<ExceptionPredicate>();
            ResultPredicates = new List<ResultPredicate<TResult>>();
        }
        ...
        internal IList<ResultPredicate<TResult>> ResultPredicates { get; }
