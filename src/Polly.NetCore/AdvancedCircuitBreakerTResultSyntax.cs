...
namespace Polly
{
    ...
    public static class AdvancedCircuitBreakerTResultSyntax
    {
        ...
        public static CircuitBreakerPolicy<TResult> AdvancedCircuitBreaker<TResult>(this PolicyBuilder<TResult> policyBuilder, double failureThreshold,
                                                                                    TimeSpan samplingDuration, int minimumThroughput, TimeSpan durationOfBreak)
        {
